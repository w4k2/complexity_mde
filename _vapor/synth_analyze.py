...
dataset_names = ['australian']
transfer_names = ["banknote", "synth"]
transfer_names = ["imagenet"] + transfer_names

# DATASET x FOLDS x TRANSFER
scores = np.load("results/transfer/synth_test_scores.npy")
transrates = np.load("results/transfer/synth_test_transrates.npy")
