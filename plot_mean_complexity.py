...
comp = np.load("results2/complexity_measures.npy")
...
ax.bar(dataset_names[:-1], mean_comp[:-1], color=colors[1:], edgecolor="black")
ax.bar(dataset_names[-1], mean_comp[-1], color="white", edgecolor="black")
